...
public class AuthorizationServerConfiguration {
    ...
    private RegisteredClient createRegisteredClientAuthorizationCode(final String clientId) {
        ...
        return RegisteredClient
                 ...
                 */.redirectUri("http://127.0.0.1:8000/login/oauth2/code/myClient").redirectUri("http://127.0.0.1:8000")
                // 授权范围（当前客户端的授权范围）
    ...
    public JWKSource<SecurityContext> jwkSource() {
        // 证书的路径
        String path = "simrobotJks.jks";
        // 证书别名
        String alias = "simrobotjks";
        // keystore 密码
        String pass = "simrobot";
    ...
    public ProviderSettings providerSettings() {
        return ProviderSettings.builder().issuer("http://uaa.pdteam.cn:9000").build();
    }
}
