<template>
  <div>
    <a-card title="代码编辑器" class="editor-card"
            head-style="flex-grow:0;"
      ...
      <div slot="extra">
        ...
        <!--语言select选择框-->
        <a-select slot="extra" style="width: 120px; margin-left: 10px" :default-value="aceConfig.selectLang"
    ...
    <a-modal v-model="visible" width="500px" title="编辑器设置(功能暂未开发)" @ok="handleOk">
      ...
      <a-row type="flex" style="margin-top: 50px">
        ...
        <a-col flex="80px">
          <a-select style="width: 120px;" :default-value="aceConfig.options.fontSize" @change="handleFontChange"
                    disabled>
